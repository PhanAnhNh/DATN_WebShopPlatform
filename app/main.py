...
app.include_router(like_router.router)  # Đăng ký router cho likes
app.include_router(follow_router.router)  # Đăng ký router cho follows
app.include_router(shop_router.router)  # Đăng ký router cho shops
app.include_router(product_router.router)  # Đăng ký router cho products
app.include_router(cart_router.router)  # Đăng ký router cho cart
app.include_router(order_router.router)  # Đăng ký router cho orders
app.include_router(reviews_router.router)  
app.include_router(review_shop_router.router)  
app.include_router(report_router.router)  # Đăng ký router cho reports
app.include_router(voucher_router.router)  # Đăng ký router cho vouchers
app.include_router(product_variants_router.router)  
app.include_router(category_router.router)  # Đăng ký router cho categories
app.include_router(share_router.router)  # Đăng ký router cho shares
